...
import { Button, Card, Col, Divider, InputNumber, Rate, Row, Tag } from "antd";
import {
  RiArrowLeftSLine,
  RiArrowRightSLine,
                ...
                <>
                  ...
                  >
                    {value.images.map((item, index) => (
                      <div key={index} className="hp-d-flex-full-center">
                        <img
                          src={
                            require(`../../../../assets/images/product/${item.img}`)
                              .default
                          }
                          alt={item.title}
                        />
                  ...
                  >
                    {value.images.map((item, index) => (
                      <div
                        key={index}
                        className="hp-slick-slide-item hp-mx-8 hp-d-flex-full-center"
                      >
                        ...
                        {value.discount ? (
                          <>
                            <span className="h2 hp-d-inline-block hp-mb-0 hp-mr-4">
                              ${discountSplit1}.
                              <sup style={{ top: -6 }}>{discountSplit2}</sup>
                            </span>
